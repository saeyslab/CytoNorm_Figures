---
title: "Figures CytoNorm Paper - extra datasets"
output: html_notebook
---

# Figures CytoNorm Paper - extra datasets
...
t <- system.time(capture.output(
  CytoNorm.normalize(model = model,
                      ...
                      outputDir = paste0("CytoNorm_ExtraDatasets_", dataset),
...
methods <- c("CytoNorm", "QuantileNorm", "MinMaxNorm" )
reduction <- list()
for(method in methods){
...
plot_emds <- function(exp_1, exp_2, emds_g, title = NULL, subtitle = NULL){
  ...
  if(is.null(title)){
    ...
    subtitle <- paste0(round(reduction[exp_1, "mean"], 4), 
                       " (±", round(reduction[exp_1, "sd"],4), ")")
  }
